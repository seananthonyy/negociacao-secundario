...
CLI (sem argumentos — roda sobre toda a base):
    python codigos/scripts/match_referencias.py
    python codigos/scripts/match_referencias.py --revalidar-dias 15  # prazo mais curto
    python codigos/scripts/match_referencias.py --force              # ignora prazo: TODAS as refs
"""
