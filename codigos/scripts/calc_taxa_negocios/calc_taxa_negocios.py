...
CLI:
    python codigos/scripts/calc_taxa_negocios.py --date 2026-05-29
    python codigos/scripts/calc_taxa_negocios.py --start 2026-05-01 --end 2026-05-29
    python codigos/scripts/calc_taxa_negocios.py --date 2026-05-29 --limit 40   # smoke test
    python codigos/scripts/calc_taxa_negocios.py --date 2026-05-29 --sem-calc   # so API (A/B)
"""
...
from b3_calc_api import CalcularYield
