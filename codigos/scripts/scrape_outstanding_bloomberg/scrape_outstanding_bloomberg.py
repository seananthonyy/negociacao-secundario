...
CLI:
    python codigos/scripts/scrape_outstanding_bloomberg.py --date 2026-06-03
    python codigos/scripts/scrape_outstanding_bloomberg.py --start 2026-06-01 --end 2026-06-05
    python codigos/scripts/scrape_outstanding_bloomberg.py --start ... --end ... --force
"""
