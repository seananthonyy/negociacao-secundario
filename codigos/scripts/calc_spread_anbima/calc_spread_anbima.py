...
CLI:
    python codigos/scripts/calc_spread_anbima.py --date 2026-06-03
    python codigos/scripts/calc_spread_anbima.py --start 2026-06-01 --end 2026-06-05
    python codigos/scripts/calc_spread_anbima.py --date 2026-06-03 --force
"""
