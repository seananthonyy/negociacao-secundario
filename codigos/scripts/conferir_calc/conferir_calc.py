"""
conferir_calc.py — o contrato da ponte com a calculadora de renda fixa.

Era o tests_fase1.py. Renomeado em 03/09/2026 para dizer o que confere, em paralelo
ao conferir_dados (que confere o contrato da camada de dados).
...
Cobre:
  ...
  #2b Integracao: coluna cdTipoAmortizacao no schema + propagacao via helpers/calc.
...
# ─── #2b: integracao schema + helpers/calc ────────────────────────────────────────
