...
CLI:
    python codigos/scripts/filtrar_trades.py --date 2026-05-27
    python codigos/scripts/filtrar_trades.py --start 2026-05-01 --end 2026-05-27
    python codigos/scripts/filtrar_trades.py --date 2026-05-27 --fundo-max 80 --corretor-bps 1.0
"""
