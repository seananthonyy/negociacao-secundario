...
`gerar_relatorio_html`. Todas liam o mesmo arquivo e faziam a mesma coisa -- menos
...
def Recarregar() -> frozenset[date]:
    ...
    if not CAMINHO_CSV.exists():
        raise FileNotFoundError(
            ...
            "Ele mora em files/Database/ junto do ipca.db e do di.db (a calculadora "
            "exige os tres na mesma pasta).")
    lidos: set[date] = set()
