...
# Raiz do projeto: Helpers/../ -> a pasta que contem Helpers/, files/ e codigos/.
RAIZ = Path(__file__).resolve().parent.parent

# Onde moram config.toml e .env. Tudo que e "arquivo" do projeto vive aqui.
DIR_FILES = RAIZ / "files"
...
def GarantirCfg() -> None:
    ...
    if cfgCache is None:
        GarantirEnv()
        with open(DIR_FILES / "config.toml", "rb") as fh:
