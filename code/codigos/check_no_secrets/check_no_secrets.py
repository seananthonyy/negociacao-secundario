...
se encontrar, nos arquivos que iriam para o repo:
  (a) valores de segredo reais (lidos do ambiente/.env via Helpers/config.py);
...
from config import ObterSegredo

ROOT    = Path(__file__).resolve().parents[2]   # a pasta com Helpers/, files/, codigos/
PROJECT = ROOT.parent                           # raiz do repositorio
