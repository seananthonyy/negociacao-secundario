...
def main() -> None:
    ...
    linhas = [
        ...
        "Script que sumiu do projeto é APAGADO em code/scripts e code/lib, senão a",
        ...
        "PROTEGIDOS = ('.db', '.env', 'destinatarios.py', 'anbima_skip_tickers.csv')",
        "",
